...
class InMemoryDbService {
    ...
    seed() {
        ...
        this.categorias.push({ id: catConstruccion, nombre: 'Construccion' }, { id: catTerminaciones, nombre: 'Terminaciones' });
        const subCortinas = uuidv4();
        const subFijaciones = uuidv4();
        const subSanitarios = uuidv4();
        this.subcategorias.push({ id: subCortinas, categoriaId: catTerminaciones, nombre: 'Cortinas' }, { id: subFijaciones, categoriaId: catConstruccion, nombre: 'Fijaciones' }, { id: subSanitarios, categoriaId: catTerminaciones, nombre: 'Sanitarios' });
        const famCortinas = uuidv4();
        const famTornillos = uuidv4();
        const famTazasBano = uuidv4();
        this.familias.push({ id: famCortinas, subcategoriaId: subCortinas, nombre: 'Cortinas Blackout' }, { id: famTornillos, subcategoriaId: subFijaciones, nombre: 'Tornillos Zincados' }, { id: famTazasBano, subcategoriaId: subSanitarios, nombre: 'Tazas de bano' });
