...
const toAuthUserResponse = (userId) => {
...
authRouter.get('/me', requireAuth, (req, res) => {
    const authUser = toAuthUserResponse(req.authUserId);
    if (!authUser) {
